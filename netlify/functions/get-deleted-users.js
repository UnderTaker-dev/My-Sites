...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Fetch all deleted users from DeletedUsers table
    const deletedUsers = [];
    await base('DeletedUsers').select({
      ...
      records.forEach(record => {
        ...
        deletedUsers.push({
          id: record.id,
          originalUserId: fields.OriginalUserId || '',
          ...
          deletionRequested: fields.DeletionRequested || false,
